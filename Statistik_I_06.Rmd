...
**Zufallsschwankungen im Schätzwert (Beispiel 1 - Angststörungen)**
...
.pull-left[
* Die relative Häufigkeit der Angststörung in dieser Population wäre $h_A=\frac{7}{50}=0.14$
...
* Wir interessieren uns für einen unbekannten wahren Parameter $θ$, der die Verteilung einer Zufallsvariable charakterisiert
...
* Je kleiner α, desto breiter das KI (strengere Irrtumswahrscheinlichkeit $\rightarrow$ mehr Konfidenz)
...
* Tabelle enthält keine Eintragung für $df = 86$, aber nächstgelegener Wert ist $df = 60$; $t_{0.975} = 2.00$
