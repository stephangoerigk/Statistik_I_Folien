...
##### 30.01.2023 | Dr. phil. Stephan Goerigk
...
* Je schneller dies geschieht, desto größer ist die Power des statistischen Verfahrens.
...
* Cohen's d ist die meist bekannte und gängigste Methode zur Bestimmung der Effektstärke. 
...
* Glass’s delta gehört zu der gleichen Familie, wie die Formeln von bereits vorgestellten Formeln von Cohen und Hedge. 
...
* Das bedeutet, das ein Effekt, der in $r$ angegeben wurde, mit jedem anderen verglichen werden kann.
