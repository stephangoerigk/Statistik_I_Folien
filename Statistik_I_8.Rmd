...
### Einheit 8: $t$-Test
##### 03.01.2023 | Dr. phil. Stephan Goerigk
...
* $n = 108$, Testpunkte normalverteilt, $\bar{x}_{I} = 99.32$ , $s_{I} = 4.03$
...
$$t = \frac{\bar{X}-μ}{\frac{\hat{\sigma}}{\sqrt{n}}} \sim t_{n-1}$$

$$t = \frac{99.32 − 100}{\frac{4.03}{\sqrt{108}}} = −1.75$$

* $df = 107$; $t_{100;0.975} = 1.98$ (kritischer Wert)

* $1.75 < 1.98 \rightarrow$ $H_{0}$ beibehalten
...
* Personen aufgrund eines oder mehrerer Variablen parallelisiert wurden (z.B. aufgrund eines Vortests werden je zwei Personen mit gleicher Punktezahl zu Paaren zusammengefasst).
...
$$t = \frac{7.22- 4.91}{\sqrt{\frac{52 \cdot 6.12 + 50 \cdot 6.54}{52+50} (\frac{1}{52}+\frac{1}{50})}}=4.64; df=n_{1}+n_{2} - 2=102$$
