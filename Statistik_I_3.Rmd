...
* Streuungsmaße beschreiben, wie start die einzelnen Werte einer Veteilung von der zentralen Tendenz abweichen
...
* A**usreißer** beeinflussen die Varianz stark, da Bezugsgröße der Mittelwert ist
...
* Die Schiefe $g1$ ist eine Maßzahl, die uns angibt, in welche Richtung eine H ̈aufigkeitsverteilung schief ist
...
names(tab) = c("Characteristic", "A (N=3)", "B (N=3)")
