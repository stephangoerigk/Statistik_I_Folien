...
* Was können wir tun, wenn wir eine **nominalskalierte AV** haben?
...
* $\chi^2$-Wert gibt Abweichung der beobachteten von den erwarteten Häufigkeiten an
...
* $\chi^2$ kann aufgrund der Quadrierung in der Formel nur positive Werte annehmen
  ...
  * Informationen über Richtung der Abweichung gehen verloren
...
* Folge: $\chi^2_{krit}$ verringert sich, Test wird eher signifikant (Teststärke nimmt zu)
...
* Bei Kontingenzanalyse:
  ...
  * $H_1:$ Es besteht irgendeine Art von Zusammenhang zwischen den Stufen des einen Merkmals und den Stufen des anderen Merkmals
...
* 49 Patient:innen hatten einen Therapieerfolg: $p_{ja}=\frac{49}{100}=0.49$

* Gegenwahrscheinlichkeit: $p_{nein}=1-0.49=0.51$

* 50 Patient:innen erhielten eine Wartelistentherapie: $p_{Warteliste}=\frac{50}{100}=0.50$
...
**Effektgröße Cramers Phi-Koeffizient (Cramers Index, CI)**
...
Dann kann Formel vereinfacht werden (Vierfelder-Tafel):
...
* Für $\chi^2$-Tests existieren theoretisch **unendlich viele $H_0$ ** Möglichkeiten (häufig: Gleichverteilungsannahme)
