...
<svg width="100%" viewBox="0 0 900 385" style="display:block; margin-top:2px;">
  ...
  <!-- CURVE LABELS -->
  <text x="245" y="32" text-anchor="middle" fill="#621C37" font-size="12" font-weight="700" font-family="inherit">H₀ ist wahr</text>
  <text x="245" y="45" text-anchor="middle" fill="#888" font-size="8.5" font-style="italic" font-family="inherit">(Nullverteilung)</text>
  <text x="608" y="32" text-anchor="middle" fill="#621C37" font-size="12" font-weight="700" font-family="inherit">H₁ ist wahr</text>
  <text x="608" y="45" text-anchor="middle" fill="#888" font-size="8.5" font-style="italic" font-family="inherit">(Alternativverteilung)</text>

  <!-- REGION LABELS -->
  <text x="185" y="160" text-anchor="middle" fill="#621C37" font-size="9.5" font-weight="600" font-family="inherit">Richtig Negativ</text>
  <text x="185" y="173" text-anchor="middle" fill="#621C37" font-size="9.5" font-family="inherit">(1−α)</text>

  <text x="397" y="197" text-anchor="middle" fill="#621C37" font-size="8.5" font-weight="600" font-family="inherit">Falsch</text>
  <text x="397" y="208" text-anchor="middle" fill="#621C37" font-size="8.5" font-weight="600" font-family="inherit">Negativ</text>
  <text x="397" y="219" text-anchor="middle" fill="#621C37" font-size="8" font-family="inherit">(β)</text>

  <text x="448" y="206" text-anchor="middle" fill="#621C37" font-size="8.5" font-weight="600" font-family="inherit">Falsch</text>
  <text x="448" y="217" text-anchor="middle" fill="#621C37" font-size="8.5" font-weight="600" font-family="inherit">Positiv</text>
  <text x="448" y="228" text-anchor="middle" fill="#621C37" font-size="8" font-family="inherit">(α)</text>

  <text x="498" y="213" text-anchor="middle" fill="#621C37" font-size="8.5" font-weight="600" font-family="inherit">p-Wert</text>

  <text x="648" y="138" text-anchor="middle" fill="#621C37" font-size="9.5" font-weight="600" font-family="inherit">Richtig Positiv</text>
  <text x="648" y="151" text-anchor="middle" fill="#621C37" font-size="9.5" font-family="inherit">(Power = 1−β)</text>
